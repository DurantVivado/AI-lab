...
def regis_coarse(low_path, high_path, slide_ratio, max_shift = 2000, points = 2):
    """
    粗配函数
    path: 
        图片路径
...
def regis_patch_hrtolr(coors,size,shift,lr_path,hr_path,ratio,redundant = 100):
    ...
    #裁剪结果
    regised_lr_patch = lr_patch[maxloc[1]:maxloc[1]+lw,maxloc[0]:maxloc[0]+lh,:]
